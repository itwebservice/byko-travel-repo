...
$username = "bykojourneys_crm_u";
$password = "wkMEL?LLUW;F";
$db_name = "bykojourneys_crm";
global $connection;
$connection = new mysqli($servername, $username, $password, $db_name);

define('BASE_URL', 'https://www.bykojourneys.co.in/crm/');
define('BASE_URL_API', 'https://www.bykojourneys.co.in/frontendAPI8/public/api/');
define('BASE_URL_B2C', 'https://www.bykojourneys.co.in/');
