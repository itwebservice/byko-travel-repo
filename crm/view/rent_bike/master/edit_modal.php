        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <select id="bike_type1" name="bike_type" style="width:100%" title="Bike Type"
                                data-toggle="tooltip" class="form-control" required>
                                <option value="<?= $sq_bike_type['entry_id']; ?>"><?= $sq_bike_type['bike_type']; ?>
                                </option>
                                <?php get_bike_types(); ?>
                            </select>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" id="bike_name1" name="bike_name"
                                onchange="locationname_validate(this.id);" placeholder="*Bike Name" title="Bike Name"
                                value="<?= $sq_bike['bike_name']; ?>" onkeypress="return blockSpecialChar(event);"
                                required>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="model_name1" name="model_name"
                                onchange="locationname_validate(this.id);" placeholder="*Model Name" title="Model Name"
                                value="<?= $sq_bike['model_name']; ?>" onkeypress="return blockSpecialChar(event);"
                                required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3 mg_tp_10">
                            <input type="number" id="seating_capacity1" name="seating_capacity" max_length="20"
                                placeholder="*Seating Capacity" title="Seating Capacity"
                                value="<?= $sq_bike['seating_capacity']; ?>" required>
                        </div>
                        <div class="col-sm-3 mg_tp_10">
                            <input type="text" id="pickup_time1" name="pickup_time" placeholder="*Pickup Time"
                                title="Pickup Time" value="<?= $pickup_time; ?>" required>
                        </div>
                        <div class="col-sm-3 mg_tp_10">
                            <input type="text" id="drop_time1" name="drop_time" placeholder="*Drop Time"
                                title="Drop Time" value="<?= $drop_time; ?>" required>
                        </div>
                        <div class="col-sm-3 mg_tp_10">
                            <select id="active_flag" name="active_flag" style="width:100%" title="Status"
                                data-toggle="tooltip" class="<?= $active_inactive_flag ?>" required>
                    ...
                    <div class="row mg_tp_20">
                        <div class="col-sm-6">
                            ...
                            <textarea class="feature_editor" name="incl" id="incl1" style="width:100% !important"
                                rows="2"><?= $sq_bike['incl']; ?></textarea>
                        </div>
                        <div class="col-sm-6">
                            <h3 class="editor_title">Exclusions</h3>
                            <textarea class="feature_editor" name="excl" id="excl1" style="width:100% !important"
                                rows="2"><?= $sq_bike['excl']; ?></textarea>
                        </div>
                    </div>
                    <div class="row mg_tp_20">
                        <div class="col-sm-6">
                            <h3 class="editor_title">Terms & Conditions</h3>
                            <textarea class="feature_editor" name="terms" id="terms1" style="width:100% !important"
                                rows="2"><?= $sq_bike['terms']; ?></textarea>
                        </div>
                        <div class="col-sm-6">
                            <h3 class="editor_title">Cancellation Policy</h3>
                            <textarea class="feature_editor" name="canc_policy" id="canc_policy1"
                                style="width:100% !important" rows="2"><?= $sq_bike['canc_policy']; ?></textarea>
                        </div>
                    </div>
...
$('#pickup_time1,#drop_time1').datetimepicker({
    datepicker: false,
    timepicker: true,
    format: "H:i"
});
...
function delete_image(image_id){
    ...
    $.ajax({
        type:'post',
        url: base_url+'controller/rent_bike/delete_image.php',
